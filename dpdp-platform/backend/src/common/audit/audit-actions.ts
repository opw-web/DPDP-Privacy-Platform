...
export type AuditAction =
  ...
  | "ERASURE_TASK_PRE_ERASURE_NOTICE_SENT"
  | "ERASURE_TASK_READY_FOR_ERASURE"
  | "ERASURE_TASK_CANCELLED"
  | "PURPOSE_SERVED_RECORDED"
  | "LEGAL_HOLD_CREATED"
  | "SDF_ASSESSMENT_CREATED"
  | "VOLUNTARY_UNDERTAKING_CREATED"
  | "VOLUNTARY_UNDERTAKING_UPDATED"
  | "CAMPAIGN_CREATED"
  | "CAMPAIGN_APPROVED"
  | "CAMPAIGN_SENT"
  | "TEMPLATE_UPDATED"
  | "BREACH_CREATED"
  | "BREACH_PRINCIPALS_NOTIFIED"
