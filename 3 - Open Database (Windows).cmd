...
rem ====================================================================
rem  3 - Open Database -- Windows launcher
rem
rem  This hands over to demo-control/open-database.sh, which is the very same
rem  script the Linux buttons run. There is deliberately no second copy
rem  of the demo logic for Windows: one script, two platforms, nothing
rem  to drift out of sync.
rem
rem  All this file does is find Git Bash and start that script.
rem ====================================================================

set "ROOT=%~dp0"
set "SCRIPT=demo-control/open-database.sh"
