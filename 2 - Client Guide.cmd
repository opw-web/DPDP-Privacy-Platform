...
rem ====================================================================
rem  2 - Client Guide -- Windows launcher
rem
rem  This hands over to demo-control/open-client-guide.sh, which is the
rem  very same script the Linux entry point runs. There is deliberately
rem  no second copy of the demo logic for Windows: one script, two
rem  platforms, nothing to drift out of sync.
rem
rem  All this file does is find Git Bash and start that script.
rem ====================================================================

set "ROOT=%~dp0"
set "SCRIPT=demo-control/open-client-guide.sh"
