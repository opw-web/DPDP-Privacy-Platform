#!/usr/bin/env bash
# Linux entry point for "4 - Show Demo Proof".
#
# The Windows launchers in the repository root call demo-control/show-demo-proof.sh
...
exec /bin/bash "$CONTROL/show-demo-proof.sh"
