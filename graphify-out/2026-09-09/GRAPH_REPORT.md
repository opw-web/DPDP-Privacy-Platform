...
### Community 9 - "age-status.service.ts"
Cohesion: 0.13
...
Cohesion: 0.09
Nodes (28): customerIdSignal(), hasSoleVerifiedCustomerIdMapping(), verifiedCustomerIdValue(), emailSignal(), phoneSignal(), lastSix(), sameDate(), SCORE_BY_SIGNAL (+20 more)

### Community 75 - "ChangeStatusDto"
Cohesion: 0.23
...
### Community 89 - "CreateComplianceRuleDto"
Cohesion: 0.18
...
### Community 115 - "UpdateComplianceRuleDto"
Cohesion: 0.20
...
### Community 130 - "SourceFieldMappingDto"
Cohesion: 0.29
...
### Community 169 - "UpdatePurposeDto"
Cohesion: 0.22
...
## Knowledge Gaps
- **1197 isolated node(s):** `ComplianceRuleRow`, `PublicComplianceRule`, `PublicAlgorithmEntry`, `AlgorithmOperation`, `PublicSdfAssessment` (+1192 more)
...
- **What connects `ComplianceRuleRow`, `PublicComplianceRule`, `PublicAlgorithmEntry` to the rest of the system?**
