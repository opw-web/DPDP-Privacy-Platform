...
```dataview
TABLE source_file, type FROM #community/csv-writerts
SORT file.name ASC
```
...
## Top bridge nodes
- [[csv-writer.ts]] - degree 12, connects to 4 communities
- [[csvRow()]] - degree 7, connects to 2 communities
- [[withCsvLetterhead()]] - degree 4, connects to 2 communities
- [[csv-writer.spec.ts]] - degree 6, connects to 1 community
- [[pack-letterhead.ts]] - degree 4, connects to 1 community