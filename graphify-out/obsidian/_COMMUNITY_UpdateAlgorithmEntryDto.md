...
```dataview
TABLE source_file, type FROM #community/UpdateAlgorithmEntryDto
SORT file.name ASC
```
...
- [[dot-update()_9]] - degree 4, connects to 2 communities
- [[UpdateAlgorithmEntryDto]] - degree 14, connects to 1 community