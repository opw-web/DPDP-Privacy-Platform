...
## Members
- [[authed()]] - code - dpdp-platform/backend/test/registers.e2e-spec.ts
- [[createDataSource()]] - code - dpdp-platform/backend/test/registers.e2e-spec.ts
- [[createEmployeeWithPermissions()]] - code - dpdp-platform/backend/test/registers.e2e-spec.ts
...
```dataview
TABLE source_file, type FROM #community/registerse2e-spects
SORT file.name ASC
```
