...
## Members
- [[@nestjscli_1]] - concept - dpdp-platform/backend/package.json
- [[@nestjsplatform-express_1]] - concept - dpdp-platform/backend/package.json
- [[@nestjsschematics_1]] - concept - dpdp-platform/backend/package.json
- [[@typescookie-parser_1]] - concept - dpdp-platform/backend/package.json
- [[@typesexpress_1]] - concept - dpdp-platform/backend/package.json
...
- [[@typesnodemailer_1]] - concept - dpdp-platform/backend/package.json
- [[@typespg_1]] - concept - dpdp-platform/backend/package.json
- [[@typessupertest_1]] - concept - dpdp-platform/backend/package.json
- [[@typescript-eslinteslint-plugin_1]] - concept - dpdp-platform/backend/package.json
- [[@typescript-eslintparser_1]] - concept - dpdp-platform/backend/package.json
...
- [[date-fns-tz_3]] - concept - dpdp-platform/backend/package.json
- [[description_2]] - code - dpdp-platform/backend/package.json
- [[eslint_2]] - concept - dpdp-platform/backend/package.json
- [[eslint-config-prettier_1]] - concept - dpdp-platform/backend/package.json
...
- [[pino-pretty_1]] - concept - dpdp-platform/backend/package.json
- [[prettier_1]] - concept - dpdp-platform/backend/package.json
- [[prisma_1]] - code - dpdp-platform/backend/package.json
- [[prisma_2]] - concept - dpdp-platform/backend/package.json
- [[private_2]] - code - dpdp-platform/backend/package.json
- [[rxjs_1]] - concept - dpdp-platform/backend/package.json
...
- [[typescript_4]] - concept - dpdp-platform/backend/package.json
- [[version_2]] - code - dpdp-platform/backend/package.json

## Live Query (requires Dataview plugin)

```dataview
TABLE source_file, type FROM #community/backend/packagejson
SORT file.name ASC
```
...
- 1 edge to [[_COMMUNITY_mailer.service.ts]]
- 1 edge to [[_COMMUNITY_test-database.ts]]
- 1 edge to [[_COMMUNITY_AppModule]]

## Top bridge nodes
- [[backendpackage.json]] - degree 60, connects to 16 communities
