...
- [[dot-constructor()_97]] - code - dpdp-platform/backend/src/modules/identity/candidates.controller.ts
...
```dataview
TABLE source_file, type FROM #community/CandidatesService
SORT file.name ASC
```
...
## Top bridge nodes
- [[CandidatesService]] - degree 12, connects to 4 communities
- [[CandidatesController]] - degree 8, connects to 3 communities
- [[dot-confirm()_1]] - degree 6, connects to 3 communities
- [[dot-confirm()]] - degree 7, connects to 2 communities
- [[dot-reject()]] - degree 7, connects to 2 communities