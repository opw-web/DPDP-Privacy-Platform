...
- [[RecipientRef_1]] - `contains` [EXTRACTED]
- [[RegistersPage.tsx]] - `imports_from` [EXTRACTED]
- [[RestrictionCell()]] - `contains` [EXTRACTED]
- [[Select]] - `imports` [EXTRACTED]
- [[SelectControl_1]] - `imports` [EXTRACTED]
- [[Textarea]] - `imports` [EXTRACTED]
- [[TextareaControl_1]] - `imports` [EXTRACTED]
- [[Transfer]] - `contains` [EXTRACTED]
- [[TransferForm()]] - `contains` [EXTRACTED]
- [[TransferFormValues]] - `contains` [EXTRACTED]
- [[TransfersTab()]] - `contains` [EXTRACTED]
