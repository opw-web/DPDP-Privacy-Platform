...
- [[dot-unknownCount()]] - code - dpdp-platform/backend/src/modules/children/age-status.controller.ts
...
```dataview
TABLE source_file, type FROM #community/age-statusservicets
SORT file.name ASC
```
...
- [[dot-setAgeStatus()]] - degree 7, connects to 1 community