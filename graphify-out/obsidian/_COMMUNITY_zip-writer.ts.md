...
```dataview
TABLE source_file, type FROM #community/zip-writerts
SORT file.name ASC
```
...
## Top bridge nodes
- [[buildZip()]] - degree 5, connects to 2 communities
- [[zip-writer.ts]] - degree 6, connects to 1 community
- [[ZipEntryInput]] - degree 2, connects to 1 community