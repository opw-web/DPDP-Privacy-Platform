...
```dataview
TABLE source_file, type FROM #community/audienceservicets
SORT file.name ASC
```
...
- [[compileAudience()]] - degree 9, connects to 6 communities
- [[audience-filter.error.ts]] - degree 6, connects to 3 communities
- [[audience-filter.types.ts]] - degree 12, connects to 2 communities
- [[AudienceFilter_1]] - degree 5, connects to 2 communities