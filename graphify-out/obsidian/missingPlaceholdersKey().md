---
source_file: "dpdp-platform/frontend/src/fiduciary/lib/breach-notification-elements.ts"
type: "code"
...
## Connections
- [[MessagingCampaignBuilderPage()]] - `calls` [EXTRACTED]
- [[MessagingCampaignBuilderPage.tsx]] - `imports` [EXTRACTED]
- [[MessagingTemplateEditorPage()]] - `calls` [EXTRACTED]
- [[MessagingTemplateEditorPage.tsx]] - `imports` [EXTRACTED]
- [[breach-notification-elements.test.ts]] - `imports` [EXTRACTED]
- [[breach-notification-elements.ts]] - `contains` [EXTRACTED]
