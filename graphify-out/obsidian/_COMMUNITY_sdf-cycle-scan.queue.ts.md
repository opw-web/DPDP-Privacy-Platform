...
## Members
- [[dot-constructor()_90]] - code - dpdp-platform/backend/src/modules/sdf/sdf-cycle-scan.service.ts
- [[dot-constructor()_91]] - code - dpdp-platform/backend/src/queues/sdf-cycle-scan.processor.ts
...
```dataview
TABLE source_file, type FROM #community/sdf-cycle-scanqueuets
SORT file.name ASC
```

## Connections to other communities
- 9 edges to [[_COMMUNITY_queues.module.ts]]
...
- 1 edge to [[_COMMUNITY_ComplianceService]]
- 1 edge to [[_COMMUNITY_PrismaService]]
- 1 edge to [[_COMMUNITY_compliance.service.ts]]
- 1 edge to [[_COMMUNITY_dot-record]]

## Top bridge nodes
- [[sdf-cycle-scan.queue.ts]] - degree 16, connects to 5 communities
- [[sdf-cycle-scan.processor.ts]] - degree 10, connects to 5 communities
- [[SdfCycleScanService]] - degree 11, connects to 3 communities
- [[dot-runForCurrentOrganization()_2]] - degree 7, connects to 3 communities
- [[SdfCycleScanQueueService]] - degree 5, connects to 3 communities