---
source_file: "dpdp-platform/backend/src/modules/identity/identity.module.ts"
type: "code"
...
- [[CandidatesController]] - `imports` [EXTRACTED]
- [[CandidatesService]] - `imports` [EXTRACTED]
- [[IdentityModule]] - `contains` [EXTRACTED]
...
- [[UnmergeController]] - `imports` [EXTRACTED]
