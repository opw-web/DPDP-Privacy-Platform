...
- [[dot-constructor()_114]] - code - dpdp-platform/backend/src/modules/consents/consents.controller.ts
...
- [[dot-getConsentStatus()]] - code - dpdp-platform/backend/src/modules/consents/consents.service.ts
- [[dot-getOrCreateRecord()]] - code - dpdp-platform/backend/src/modules/consents/consents.service.ts
- [[dot-getPublishedVersion()]] - code - dpdp-platform/backend/src/modules/notices/notices.service.ts
- [[dot-listForPrincipal()_1]] - code - dpdp-platform/backend/src/modules/consents/consents.controller.ts
- [[dot-listForPrincipal()_2]] - code - dpdp-platform/backend/src/modules/consents/consents.service.ts
...
```dataview
TABLE source_file, type FROM #community/ConsentsService
SORT file.name ASC
```
