...
- [[PURPOSE_PUBLIC_SELECT]] - `contains` [EXTRACTED]
- [[PrismaService]] - `imports` [EXTRACTED]
- [[PublicPurpose]] - `contains` [EXTRACTED]
- [[PurposeRow]] - `contains` [EXTRACTED]
- [[PurposesService]] - `contains` [EXTRACTED]
...
- [[toPublicPurpose()]] - `contains` [EXTRACTED]
