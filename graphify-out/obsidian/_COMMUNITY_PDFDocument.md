...
- [[dot-constructor()_26]] - code - dpdp-platform/backend/src/modules/evidence/pdfkit.d.ts
...
- [[dot-lineTo()]] - code - dpdp-platform/backend/src/modules/evidence/pdfkit.d.ts
- [[dot-moveDown()]] - code - dpdp-platform/backend/src/modules/evidence/pdfkit.d.ts
- [[dot-moveTo()]] - code - dpdp-platform/backend/src/modules/evidence/pdfkit.d.ts
- [[dot-stroke()]] - code - dpdp-platform/backend/src/modules/evidence/pdfkit.d.ts
- [[dot-text()]] - code - dpdp-platform/backend/src/modules/evidence/pdfkit.d.ts
...
```dataview
TABLE source_file, type FROM #community/PDFDocument
SORT file.name ASC
```
