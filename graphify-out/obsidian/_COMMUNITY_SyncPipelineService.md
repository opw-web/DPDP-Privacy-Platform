...
## Members
- [[dot-constructor()_70]] - code - dpdp-platform/backend/src/modules/sync/sync-error.ts
- [[dot-constructor()_71]] - code - dpdp-platform/backend/src/modules/sync/sync-error.spec.ts
- [[dot-constructor()_72]] - code - dpdp-platform/backend/src/modules/sync/sync-error.ts
- [[dot-finalize()]] - code - dpdp-platform/backend/src/modules/sync/sync-pipeline.service.ts
- [[dot-process()_6]] - code - dpdp-platform/backend/src/queues/sync.processor.ts
...
- [[sync-error.spec.ts]] - code - dpdp-platform/backend/src/modules/sync/sync-error.spec.ts
- [[sync-error.ts]] - code - dpdp-platform/backend/src/modules/sync/sync-error.ts
- [[zeroCounts()]] - code - dpdp-platform/backend/src/modules/sync/sync-pipeline.service.ts

## Live Query (requires Dataview plugin)

```dataview
TABLE source_file, type FROM #community/SyncPipelineService
SORT file.name ASC
```

## Connections to other communities
- 11 edges to [[_COMMUNITY_ScopedTransactionClient]]
...
- [[SyncRunSummary]] - degree 4, connects to 2 communities
- [[sync-error.ts]] - degree 7, connects to 1 community
