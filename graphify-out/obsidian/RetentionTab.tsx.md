...
- [[PurposeRef]] - `contains` [EXTRACTED]
- [[RETENTION_LEGAL_BASIS_TYPE_OPTIONS]] - `imports` [EXTRACTED]
- [[RETENTION_LEGAL_BASIS_TYPE_VALUES]] - `imports` [EXTRACTED]
- [[RETENTION_TRIGGER_TYPE_OPTIONS]] - `imports` [EXTRACTED]
- [[RETENTION_TRIGGER_TYPE_VALUES]] - `imports` [EXTRACTED]
- [[RETENTION_UNIT_OPTIONS]] - `imports` [EXTRACTED]
- [[RETENTION_UNIT_VALUES]] - `imports` [EXTRACTED]
- [[RegistersPage.tsx]] - `imports_from` [EXTRACTED]
- [[RetentionForm()]] - `contains` [EXTRACTED]
- [[RetentionFormValues]] - `contains` [EXTRACTED]
