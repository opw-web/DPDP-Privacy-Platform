...
- [[AudienceFilter]] - code - dpdp-platform/frontend/src/fiduciary/components/messaging/AudienceBuilder.tsx
...
```dataview
TABLE source_file, type FROM #community/AudienceBuildertsx
SORT file.name ASC
```
...
- [[AudienceBuilder()]] - degree 8, connects to 1 community
- [[AudienceBuilder.test.tsx]] - degree 7, connects to 1 community
- [[AudienceFilter]] - degree 3, connects to 1 community
- [[AudiencePreview]] - degree 3, connects to 1 community