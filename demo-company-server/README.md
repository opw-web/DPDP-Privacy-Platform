...
columns. Task 10's deterministic generator should call `openDb()` and
`INSERT` directly into `marketing_customers`, `sales_customers`,
`support_users`, and `ecommerce_customers`.
